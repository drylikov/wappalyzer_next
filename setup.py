...
setup(
    ...
    author_email='denis.rylikov@protonmail.com',
    license='',
    url='https://github.com/drylikov/wappalyzer_next',
    download_url='https://github.com/drylikov/wappalyzer_next/archive/1.0.14.zip',
